...
LCTL_T(KC_LEFT), KC_Z, 	    KC_X,      KC_C,      KC_V,       KC_B,     KC_UP,       KC_ENT,      KC_N,	KC_M,       KC_COMM,   KC_DOT,    KC_SLSH, RCTL_T(KC_RGHT),
// '----------'----------'----------+----------+----------+----------+-.---------' '---------.-+----------+----------+----------+----------'----------'----------'
//                                	|   Win    |   Alt  |   Lower    |/  Space  /   \  Enter  \|   AltGr  |  Raise   |   Bksp   |
//									|		   |	      |	         |  Shift LSFT_T(KC_SPC)  /     \  Shift  |          |          |          |
                                      KC_LGUI,   KC_LALT ,  TT(1) , LSFT_T(KC_SPC),RSFT_T(KC_BSPC), TT(2), KC_DEL, KC_RALT
//                                  '----------'----------'----------'--------'       '--------'----------'----------'----------'
),
...
[1] = LAYOUT(
  ...
  _______, KC_PGUP,   KC_UP,  KC_PGDN, XXXXXXX, XXXXXXX,                         KC_HASH,    KC_KP_4,    KC_KP_5,    KC_KP_6, XXXXXXX, XXXXXXX,
  KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END, KC_RBRC,                         KC_AMPR,    KC_KP_1,    KC_KP_2,    KC_KP_3, XXXXXXX, XXXXXXX,
  _______, XXXXXXX, KC_PAST,  KC_PPLS, KC_PSLS,  KC_PEQL, _______,       _______,  KC_DLR,    KC_KP_0, KC_KP_DOT, KC_COLN, KC_PMNS, _______,
...
[3] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ASTR,                       XXXXXXX, XXXXXXX, XXXXXXX, RGB_RMOD, RGB_SAD, RGB_M_P,
...
//                                	|   Win    |   Alt  |   Lower    |/  Space  /   \  Enter  \|   AltGr  |  Raise   |   Bksp   |
//									|		   |	      |	         |  Shift LSFT_T(KC_SPC)  /     \  Shift  |          |          |          |
                                      XXXXXXX,   KC_LSFT ,  KC_C , KC_SPC,              RSFT_T(KC_ENT), TO(0), KC_BSPC, KC_RWIN
//                                  '----------'----------'----------'--------'       '--------'----------'----------'----------'
  ),
  [5] = LAYOUT(
  _______, _______, _______ ,  _______, _______, _______, _______,     _______, _______, _______, _______, _______, _______, _______,
